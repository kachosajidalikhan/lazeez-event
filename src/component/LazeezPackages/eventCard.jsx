...
export default function EventCard({ image, title, description }) {
    return (
        <div className="z-10 rounded-lg px-4 flex flex-col items-center md:items-start  text-center">
            ...
            <div className="flex flex-col items-center md:items-start px-4 md:p-0">
