...
export default function EventCard({ id,image, title, description }) {
    ...
    return (
        <div onClick={()=>{nav(`/Sub-Packages/${id}`)}} className="z-10 rounded-lg flex flex-col items-center md:items-start  text-center">
            <ScrollAnimatedRight>
            ...
            <h2 className="text-white Poppins-bold text-[40px] mb-2 text-center">{title}</h2>
